...
<div class="match-area bg wrapper">
    ...
    <div class="heading-area">
        <div class="container">
            <div class="content">
                <h1 class="main-title">
                    Bet on your favorite Teams of <br/>the Group D <br/><span class="dark">AxioChain</span>
            ...
            <div class="action">
                <a href="./groupD.php" class="btn secondary full">
    ...
    <?php
        $team1 = array("Argentina","Croatia","Argentina","Nigeria","Nigeria"  ,"Iceland");
        ...
        $oddTeam2  = array(10.00,5.25,4.00,2.95,1.45,1.78);
...
<script>
    ...
    var team1 = ["Argentina","Croatia","Argentina","Nigeria","Nigeria"  ,"Iceland"];
    var team2 = ["Iceland"  ,"Nigeria","Croatia"  ,"Iceland","Argentina","Croatia"];
            ...
            if (!error && result.args.tipe==0 && result.args.gameID==gameID)
            {
                if(result.args.win==0) {
                    ...
                    if(result.args.win==1) {
                        messageBet = "the victory of " + team1[gameID-19];
                    } else {
                        messageBet = "the victory of " + team2[gameID-19];
                    }
                }
