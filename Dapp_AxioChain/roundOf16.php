...
<div class="match-area bg wrapper">
    ...
    <?php
        $team1 = array("1C","1A","1B","1D","1E","1G","1F","1H");
        $team2 = array("2D","2B","2A","2C","2F","2H","2E","2G");
        $flagTeam1 = array("img/rus.png","img/egy.png","img/rus.png","img/uru.png","img/uru.png","img/ksa.png","img/uru.png","img/ksa.png");
        $flagTeam2 = array("img/ksa.png","img/uru.png","img/egy.png","img/ksa.png","img/rus.png","img/egy.png","img/rus.png","img/egy.png");
        ...
        $oddTeam1  = array(1.44,7.01,2.05, 1.21,2.25,5.01,2.25,5.01);
        $oddTeam2  = array(9.01,1.60,3.81,15.01,3.41,1.72,3.41,1.72);
