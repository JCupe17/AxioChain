...
<div class="match-area bg wrapper">
    ...
    <div class="heading-area">
        <div class="container">
            <div class="content">
                <h1 class="main-title">
                    Bet on your favorite Teams of <br/>the Group E <br/><span class="dark">AxioChain</span>
            ...
            <div class="action">
                <a href="./groupE.php" class="btn secondary full">
    ...
    <?php
        $team1 = array("Costa Rica","Brazil"     ,"Brazil"    ,"Serbia"     ,"Serbia","Switzerland"  );
        $team2 = array("Serbia"    ,"Switzerland","Costa Rica","Switzerland","Brazil","Costa Rica");
        $flagTeam1 = array("img/crc.png","img/bra.png","img/bra.png","img/srb.png","img/srb.png","img/sui.png");
        $flagTeam2 = array("img/srb.png","img/sui.png","img/crc.png","img/sui.png","img/bra.png","img/crc.png");
        $dateMatch = array("17 Jun, 14:00","17 Jun, 20:00","22 Jun, 14:00","22 Jun, 20:00","27 Jun, 20:00","27 Jun, 20:00");
        $cityMatch = array("Samara","Rostov-On-Don","St Petersburg","Kaliningrad","Moscow","Nizhny Novgorod");
        $oddTeam1  = array(4.60,1.38, 1.17,2.95,8.50,1.85);
        $oddDraw   = array(3.20,4.50, 6.25,3.00,4.60,3.30);
        $oddTeam2  = array(1.85,8.00,18.00,2.50,1.35,4.40);
...
<script>
    ...
    var team1 = ["Costa Rica","Brazil"     ,"Brazil"    ,"Serbia"     ,"Serbia","Switzerland"];
    var team2 = ["Serbia"    ,"Switzerland","Costa Rica","Switzerland","Brazil","Costa Rica" ];
            ...
            if (!error && result.args.tipe==0 && result.args.gameID==gameID)
            {
                if(result.args.win==0) {
                    ...
                    if(result.args.win==1) {
                        messageBet = "the victory of " + team1[gameID-25];
                    } else {
                        messageBet = "the victory of " + team2[gameID-25];
                    }
                }
        ...
        axioChain.getBetsMatch(gameID,function(error,result) {
            ...
            for (betID of betList) {
                axioChain.bets(betID,function(error,result) {
                    ...
                    messageBet = getMessageBet(user.winner,gameID-6*4);
