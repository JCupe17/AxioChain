...
<div class="match-area bg wrapper">
    ...
    <div class="heading-area">
        <div class="container">
            <div class="content">
                <h1 class="main-title">
                    Bet on your favorite Teams of <br/>the QUARTER-FINALS<br/><span class="dark">AxioChain</span>
            ...
            <div class="action">
                <a href="./quarterFinals.php" class="btn secondary full">
    ...
    <?php
        ...
        $resultTeam1  = array(0,1,0,'2(3)');
        $resultTeam2  = array(2,2,2,'2(4)');
