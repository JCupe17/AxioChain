...
<div class="match-area bg wrapper">
    ...
    <div class="heading-area">
        <div class="container">
            <div class="content">
                <h1 class="main-title">
                    Bet on your favorite Teams of <br/>the Group F <br/><span class="dark">AxioChain</span>
            ...
            <div class="action">
                <a href="./groupF.php" class="btn secondary full">
    ...
    <?php
        $team1 = array("Germany","Sweden"        ,"Korea Republic","Germany","Korea Republic","Mexico"  );
        $team2 = array("Mexico" ,"Korea Republic","Mexico"        ,"Sweden" ,"Germany"       ,"Sweden");
        $flagTeam1 = array("img/ger.png","img/swe.png","img/kor.png","img/ger.png","img/kor.png","img/mex.png");
        $flagTeam2 = array("img/mex.png","img/kor.png","img/mex.png","img/swe.png","img/ger.png","img/swe.png");
        $dateMatch = array("17 Jun, 17:00","18 Jun, 14:00","23 Jun, 17:00","23 Jun, 20:00","27 Jun, 16:00","27 Jun, 16:00");
        $cityMatch = array("Moscow","Nizhny Novgorod","Rostov-On-Don","Sochi","Kazan","Ekaterinburg");
        $oddTeam1  = array(1.48,2.05,4.70,1.40,10.50,2.45);
        $oddDraw   = array(4.10,3.10,3.40,4.40, 5.25,3.10);
        $oddTeam2  = array(6.75,3.90,1.78,7.50, 1.27,2.95);
...
<script>
    ...
    var team1 = ["Germany","Sweden"        ,"Korea Republic","Germany","Korea Republic","Mexico"];
    var team2 = ["Mexico" ,"Korea Republic","Mexico"        ,"Sweden" ,"Germany"       ,"Sweden"];
            ...
            if (!error && result.args.tipe==0 && result.args.gameID==gameID)
            {
                if(result.args.win==0) {
                    ...
                    if(result.args.win==1) {
                        messageBet = "the victory of " + team1[gameID-31];
                    } else {
                        messageBet = "the victory of " + team2[gameID-31];
                    }
                }
        ...
        axioChain.getBetsMatch(gameID,function(error,result) {
            ...
            for (betID of betList) {
                axioChain.bets(betID,function(error,result) {
                    ...
                    messageBet = getMessageBet(user.winner,gameID-6*5);
