...
<div class="match-area bg wrapper">
    ...
    <div class="heading-area">
        <div class="container">
            <div class="content">
                <h1 class="main-title">
                    Bet on your favorite Teams of <br/>the Group G <br/><span class="dark">AxioChain</span>
            ...
            <div class="action">
                <a href="./groupG.php" class="btn secondary full">
    ...
    <?php
        $team1 = array("Belgium","Tunisia","Belgium","England","Panama" ,"England");
        $team2 = array("Panama" ,"England","Tunisia","Panama" ,"Tunisia","Belgium");
        $flagTeam1 = array("img/bel.png","img/tun.png","img/bel.png","img/eng.png","img/pan.png","img/eng.png");
        $flagTeam2 = array("img/pan.png","img/eng.png","img/tun.png","img/pan.png","img/tun.png","img/bel.png");
        $dateMatch = array("18 Jun, 17:00","18 Jun, 20:00","23 Jun, 14:00","23 Jun, 14:00","28 Jun, 20:00","28 Jun, 20:00");
        $cityMatch = array("Sochi","Volgograd","Moscow","Nizhny Novgorod","Saransk","Kaliningrad");
        $oddTeam1  = array( 1.16,8.25,1.32, 1.20,3.60,2.85);
        $oddDraw   = array( 6.50,4.20,4.90, 5.75,3.15,3.25);
        $oddTeam2  = array(19.00,1.40,9.25,16.00,2.10,2.40);
