...
<div class="match-area bg wrapper">
    ...
    <div class="heading-area">
        <div class="container">
            <div class="content">
                <h1 class="main-title">
                    Bet on your favorite Teams of <br/>the Group H <br/><span class="dark">AxioChain</span>
            ...
            <div class="action">
                <a href="./groupH.php" class="btn secondary full">
    ...
    <?php
        $team1 = array("Colombia","Poland" ,"Japan"  ,"Poland"  ,"Japan" ,"Senegal" );
        $team2 = array("Japan"   ,"Senegal","Senegal","Colombia","Poland","Colombia");
        $flagTeam1 = array("img/col.png","img/pol.png","img/jpn.png","img/pol.png","img/jpn.png","img/sen.png");
        $flagTeam2 = array("img/jpn.png","img/sen.png","img/sen.png","img/col.png","img/pol.png","img/col.png");
        $dateMatch = array("19 Jun, 14:00","19 Jun, 17:00","24 Jun, 17:00","24 Jun, 20:00","28 Jun, 16:00","28 Jun, 16:00");
        $cityMatch = array("Saransk","Moscow","Ekaterinburg","Kazan","Volgograd","Samara");
        $oddTeam1  = array(1.65,2.30,3.50,3.25,4.25,3.90);
        $oddDraw   = array(3.50,3.10,3.20,3.15,3.50,3.25);
        $oddTeam2  = array(5.50,3.20,2.10,2.25,1.85,1.95);
...
<script>
    ...
    var team1 = ["Colombia","Poland" ,"Japan"  ,"Poland"  ,"Japan" ,"Senegal" ];
    var team2 = ["Japan"   ,"Senegal","Senegal","Colombia","Poland","Colombia"];
