...
contract MatchOrder is MatchFactory , AxioTestCoin {
    ...
    //event NewBetEvent(uint32 betID,uint32 stake, uint8 win, string pseudo);
    struct Bet {
    ...
    function placeOrder (uint _gameID,uint8 win,uint32 _value) external betRequirement(gameID)  {
        ...
        //emit NewBetEvent(betID, _value, win, pseudos[msg.sender]);
