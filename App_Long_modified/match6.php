...
<div class="match-area bg wrapper">
    ...
    <div class="container">
        <div class="content-area">
            ...
            <h1 class="title">Bayern / Dortmund</h1>
            ...
            <form class="form">
                ...
                <div class="panel input">
                    <div class="group">
                        ...
                        <label type="text" class="control">1,40</label>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <label type="text" class="control">6,50</label>
                    </div>
                </div>
        ...
        <div class="container">
            <div id="items" class="items">
                ...
                <div class="item">
                    <div class="meta">
                        <div class="inner">
                            <span id="date" class="date">27/03/2018</span>
                ...
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                            Othmane bet 25 Axiocoin on the victory of Dortmund
                            </div>
                        </div>
                    </div>
                </div>
