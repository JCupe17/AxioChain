            ...
            <div id="items" class="items">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div id="part1" class="text">
                                Paul bet 2 <img src="img/logo-coin.png" alt=""/> on Juventus
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                                Vincent bet 4 <img src="img/logo-coin.png" alt=""/> on Real
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                                Othmane bet 3 <img src="img/logo-coin.png" alt=""/> a draw
                            </div>
                        </div>
                    </div>
                </div>
    ...
    if (!error && result.args.tipe==0 && result.args.gameID==1)
        {
            ...
            $("#part1").html(result.args.pseudo +'bet'+result.args.stake+'Axiocoin on' +l);
        } else {
            console.log(error);
        }
});
...
$("#button").click(function() {
    ...
    l=0;
    if($("#team").val()=="Juventus"){
        l=1;
    }
    else{if($("#team").val()=="Real"){
        l=2;
    }
