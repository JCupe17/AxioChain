...
<div class="match-area bg wrapper">
    ...
    <div class="container">
        <div class="content-area">
            ...
            <h1 class="title">Seville / Bayern Munich</h1>
            ...
            <form class="form">
                ...
                <div class="panel input">
                    <div class="group">
                        ...
                        <label type="text" class="control">4,60</label>
                    </div>

                    <div class="group">
                        <label class="label">Draw</label>
                        <label type="text" class="control">3,80</label>
                    </div>

                    <div class="group">
                        <label class="label">2</label>
                        <label type="text" class="control"1>1,70</label>
                    </div>
                </div>
            ...
            <div id="items" class="items">
                ...
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                                Joanne bet 40 Axiocoin on the victory of Bayern
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                            Othmane bet 100 Axiocoin on the victory of Bayern
                            </div>
                        </div>
                    </div>
                </div>
...
blokkEvent.watch(function(error, result){
    if (!error && result.args.tipe==0 && result.args.gameID==2)
        {
            vh="the victory of Seville";
            va="the victory of Bayern";
            vd="a draw";
            l="";
