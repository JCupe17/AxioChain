...
<div class="match-area bg wrapper">
    ...
    <div class="container">
        <div class="content-area">
            ...
            <h1 class="title">Barcelona / Roma</h1>
            ...
            <form class="form">
                ...
                <div class="panel input">
                    <div class="group">
                        ...
                        <label type="text" class="control">1,22</label>
                    </div>

                    <div class="group">
                        <label class="label">Draw</label>
                        <label type="text" class="control">5,75</label>
                    </div>

                    <div class="group">
                        <label class="label">2</label>
                        <label type="text" class="control">12,00</label>
                    </div>
                </div>
            ...
            <div id="items" class="items">
                ...
                <div class="item">
                    <div class="meta">
                        <div class="inner">
                            ...
                            <span id="time2" class="time">10h01</span>
                        </div>
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                            Joanne bet 40 Axiocoin on the victory of Barcelona
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                            Othmane bet 60 Axiocoin on the victory of Barcelona
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                            vincent bet 30 Axiocoin on the victory of Roma
                            </div>
                        </div>
                    </div>
                </div>
...
blokkEvent.watch(function(error, result){
    if (!error && result.args.tipe==0 && result.args.gameID==4)
        {
            console.log("l'event est arrivé");
            vh="the victory of Barcelona";
            va="the victory of Roma";
            vd="a draw";
            l="";
...
$("#button").click(function() {
    ...
    console.log(l);
    Match.placeOrder(4,l, $("#value").val(), function(error, result){
        if(!error){
            console.log(result);}
        else{
            console.error(error);}
