...
<div class="match-area bg wrapper">
    ...
    <div class="container">
        <div class="content-area">
            ...
            <h1 class="title">Liverpool / Man City</h1>
            ...
            <form class="form">
                ...
                <div class="panel input">
                    ...
                    <div class="group">
                        ...
                        <label type="text" class="control">3,40</label>
                    </div>

                    <div class="group">
                        <label class="label">2</label>
                        <label type="text" class="control">2,40</label>
                    </div>
                </div>
            ...
            <div id="items" class="items">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div id="part1" class="text">
                               Massi bet 20 Axiocoin on the victory of Man City
                            </div>
                        </div>
                    </div>
                </div>
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                            Joanne bet 30 Axiocoin on the victory of Man city
                            </div>
                        </div>
                    </div>
                </div>
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                            Othmane bet 45 Axiocoin on the victory of Liverpool
                            </div>
                        </div>
                    </div>
                </div>
...
blokkEvent.watch(function(error, result){
    if (!error && result.args.tipe==0 && result.args.gameID==3)
        {   
            ...
            var d= new Date();
            $("#time").html(d.getHours()+'h'+d.getMinutes());
...
$("#button").click(function() {
    ...
    console.log(l);
    Match.placeOrder(3,l, $("#value").val(), function(error, result){
        if(!error){
            console.log(result);}
        else{
            console.error(error);}
