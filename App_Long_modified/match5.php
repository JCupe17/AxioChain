...
<div class="match-area bg wrapper">
    ...
    <div class="container">
        <div class="content-area">
            ...
            <h1 class="title">Schalke / Fribourg</h1>
            ...
            <form class="form">
                ...
                <div class="panel input">
                    <div class="group">
                        ...
                        <label type="text" class="control">1,52</label>
                    </div>

                    <div class="group">
                        <label class="label">Draw</label>
                        <label type="text" class="control">3,70</label>
                    </div>

                    <div class="group">
                        <label class="label">2</label>
                        <label type="text" class="control">6,25</label>
                    </div>
                </div>
            ...
            <div id="items" class="items">
                ...
                <div class="item">
                    <div class="meta">
                        <div class="inner">
                            ...
                            <span id="time2" class="time">18h58</span>
                        </div>
                    </div>
                    ...
                    <div class="info">
                        <div class="inner">
                            <div id="part1" class="text">
                                Paul bet 20 Axiocoin on Juventus
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                                Massi bet 40 Axiocoin on a draw
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="info">
                        <div class="inner">
                            <div class="text">
                                Othmane bet 50 Axiocoin on the victory of Schalke
                            </div>
                        </div>
                    </div>
                </div>
...
blokkEvent.watch(function(error, result){
    if (!error && result.args.tipe==0 && result.args.gameID==5)
        {
            vh="the victory of Schalke";
            va="the victory of Fribourg";
            vd="a draw";
            l="";
...
$("#button").click(function() {
    ...
    console.log(l);
    Match.placeOrder(5,l, $("#value").val(), function(error, result){
        if(!error){
            console.log(result);}
        else{
            console.error(error);}
